...
# # Define Router state for branching logic
# class Router(TypedDict):
#     next: Literal["information_node", "booking_node", "FINISH"]
#     reasoning: str

# # Define shared state of the agent
# class AgentState(TypedDict):
#     messages: Annotated[list[Any], add_messages]
#     id_number: int
#     next: str
...
#     def __init__(self):
#         llm_model = LLMModel()
#         self.llm_model = llm_model.get_model()  # Groq model instance
...
#         # Actual LLM invocation (Groq)
#         llm_response = self.llm_model.invoke(messages)
#         print("===== LLM Raw Response =====")
#         print(llm_response)

#         # TEMP hardcoded routing logic
#         response = {"next": "information_node", "reasoning": "Hardcoded to information_node for testing"}
#         goto = response["next"]
#         if goto == "FINISH":
#             goto = END
...
#         if query:
#             update["query"] = query
#             update["messages"] = [HumanMessage(content=f"user's identification number is {state['id_number']}")]
...
#             "related to the hospital based on the query. You have access to the tool. "
#             "Make sure to ask user politely if you need any further information to execute the tool. "
#             "For your information, always consider current year is 2024."
#         )
...
#             "You have access to the tool. Make sure to ask user politely if you need any further information to "
#             "execute the tool. For your information, always consider current year is 2024."
#         )
