...
#     "It is crucial to use the tools available to answer the user's query accurately and efficiently. "
...
#     "You must respond with a JSON object containing 'next' and 'reasoning' keys. For example: {'next': 'information_node', 'reasoning': 'User is asking about doctor availability'}\n"
# )
